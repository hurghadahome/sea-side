...
#Здравствуйте.
#Игра в морской бой. 
#Расширить консоль до двух полей, первое это поле бота второе снизу поле игрока, все они подписаны.
#Выше поля бота есть еще одно поле для проверки правильного расставления кораблей ботом ....оставлено специально
#его нужно закрыть чтоб не подсматривать, в идеале его можно убрать.
#Между полями счет точным выстрелам.
#Если поля не строятся перезапустить игру для корректного построения своих кораблей ботом.
#Далее игроку надо расставить свои корабли.
#Если корабль некорректно выставлен он стирается и предлагается выставить его корректно или предлагается ввести корректные значения.
#В случае когда игрок выбивает все корабли бота консоль меняется и на ее месте появляется  консоль с полями на которых написаны поздравления.
#При поражении так же консоль сменяется с полями с надписью о проигрыше.
#Приятной игры друзья.
#Не смог понять как сделать так что бы в конце игры убрать надпись ввести значения для следующего 
#хода......написано все методом тыка и на коленке сорри ........я еще учусь.